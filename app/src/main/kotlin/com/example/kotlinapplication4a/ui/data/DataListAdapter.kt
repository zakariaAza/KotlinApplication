...
class DataListAdapter: RecyclerView.Adapter<DataListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding: ItemDataBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.context), com.example.kotlinapplication4a.R.layout.item_data, parent, false)
